...
namespace Auto_BL.Models
{
    public class FtpTools
    {
        ...
        private string[] GetFileList(string path, string WRMethods)
        {
            ...
            {
                LogUtil.WriteLog("获取FTP文件列表失败：" + ex.Message);
                return null;
            }
        }
        ...
        public void Upload(string filename)
        {
            ...
            {
                LogUtil.WriteLog("上传文件到FTP失败：" + ex.Message);
            }
        }
        /**/
        ...
        public void DeleteFileName(string fileName)
        {
            ...
            {
                LogUtil.WriteLog("删除FTP文件失败：" + ex.Message);
            }
        }
        //创建目录  
        public void MakeDir(string dirName)
        {
            ...
            {
                LogUtil.WriteLog("创建FTP目录失败：" + ex.Message);
            }
        }
        //删除目录  
        public void delDir(string dirName)
        {
            ...
            {
                LogUtil.WriteLog("删除FTP目录失败：" + ex.Message);
            }
        }
        //获得文件大小  
        public long GetFileSize(string filename)
        {
            ...
            {
                LogUtil.WriteLog("获取FTP文件大小失败：" + ex.Message);
            }
            return fileSize;
        }
        //文件改名  
        public void Rename(string currentFilename, string newFilename)
        {
            ...
            {
                LogUtil.WriteLog("更改FTP文件名称失败：" + ex.Message);
            }
        }
        //获得文件明细  
        public string[] GetFilesDetailList()
        {
            return GetFileList("ftp://" + FtpConfig.ftpUrl + "/",WebRequestMethods.Ftp.ListDirectoryDetails);
        }
        //获得文件明细 
        public string[] GetFilesDetailList(string path)
        {
            return GetFileList("ftp://" + FtpConfig.ftpUrl + "/" + path,WebRequestMethods.Ftp.ListDirectoryDetails);
        }
    }
}
